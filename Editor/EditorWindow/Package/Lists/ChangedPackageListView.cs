...
{
    public sealed class ChangedPackageListView : BasePackageListView<ChangedPackageElement>
    {
        private IPackageHandler _inputHandler;

        public void SetInputHandler(IPackageHandler handler)
        {
            _inputHandler = handler;
        }

        protected override void OnBindItem(ChangedPackageElement item, int index)
        {
        ...
        protected override void OnUnbindItem(ChangedPackageElement item, int index)
        {
