...
{
    public sealed class CommonPackageListView : BasePackageListView<CommonPackageElement>
    {
        ...
        protected override void OnBindItem(CommonPackageElement item, int index)
        {
            base.OnBindItem(item, index);
            item.OnUnpublishClicked += OnPackageUnpublishClicked;
        }

        protected override void OnUnbindItem(CommonPackageElement item, int index)
        {
