...
{
    /// <remarks>Source: <see href="https://github.com/verdaccio/verdaccio/blob/master/packages/core/types/src/manifest.ts#L88"/></remarks>
    public class Manifest : FullRemoteManifest, IPublishManifest
    {
    ...
    /// <list type="bullet">
    /// <item>
    ///   <description><see cref="Repository"/>. Types: string | RepositoryInfo</description>
    /// </item>
    /// <item>
    ...
    /// </list>
    /// </remarks>
    public class FullRemoteManifest
    {
        [JsonProperty("_id")]
        [DefaultValue("")]
    ...
    public interface IPublishManifest
    {
        [JsonProperty("_attachments")] public Attachments Attachments { get; set; }
    }
}
